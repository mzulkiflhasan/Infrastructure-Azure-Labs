...
3. In Microsoft Edge, in the Azure portal, click **+ Create a resource**, click **Compute**, and then click **Windows Server 2016 Datacenter**.

4. On the Basics tab of the **Create a virtual machine** blade, specify the following:

  -  Subscription: the name of your Azure subscription
  
  -  Resource group : click **Create new** and, in the **Name** text box, type **20533E0301-LabRG**, and click **OK**
  
  -  Virtual Machine name: **20533E03labVM1**
  
  -  Region : In the drop-down list, select an Azure region close to the location of your lab and in which you can provision Azure VMs
  
  -  Availability options : **Availability Set**
  
  -  Availability Set : click **Create new**,  in the **Create new** pane specify the following, and click **OK**:
  ...
  -  Size : if needed, change the default size to the size specified by the instructor. To change the size, click **Change size**, on the **Select a VM size** blade, select the designated VM size, and click **Select**.
...
5. Click **Next : Disks >** and set OS disk type to **Standard HDD**.

6. Click **Next : Networking >** and specify the following:

  -  Virtual network : click **Create new** and on the **Create virtual network blade** use the following values and click **OK**
...
7. Click **Next : Management >** and specify the following:
...
8. Click **Next : Guest config >** and accept the default settings.
    
9. Click **Next : Tags >** and accept the default settings.
    
10. Click **Next : Review + create**, ensure that validation passes, and click **Create**.

11. Wait for the deployment to complete successfully.

12. Leave the Microsoft Edge with the Azure portal window open.
...
7. If needed, in the Deploy to Resource Group window, click **Add an account** and, when prompted, sign in by using an account with the Owner role in your Azure subscription.

8. In the Deploy to Resource Group window, ensure that the target subscription appears in the **Subscription** drop-down list. 

9. In the Deploy to Resource Group window, click the **Resource Group** drop-down box, and then click **20533E0301-LabRG**.

10. In the Deploy to Resource Group window, click **Edit Parameters**.

11. In the Edit Parameters window, specify the parameter values according to details in the following list:
...
12. In the Edit Parameters window, ensure that the **Save passwords** check box is enabled and then click **Save**.

13. In the Deploy to Resource Group window, click **Deploy**. Wait for the deployment to complete.
...
14. In the Solution Explorer pane, expand the **Templates** folder and click **Azuredeploy.parameters.json**. In the main window pane, notice that the parameters that you entered in the first deployment are saved in this file. You can reuse these parameters for the deployment of the second app server.

15. In the Solution Explorer pane, right-click **ResDevLinuxDeploy**, click **Deploy**, and then click **20533E0301-LabRG**.

16. In the Deploy to Resource Group window, click **Edit Parameters**.

17. In the Edit Parameters window, in the vmName **Value** box, type **20533E03LabVM4**, and then click **Save**.

18. In the Deploy to Resource Group window, click **Deploy**. Wait for the deployment to complete.
...
19. In the Visual Studio, click **File** and then on the drop-down menu, click **Close Solution**.

20. Leave Visual Studio open.
...
> **Note** If you are using AzureRM 6.8.1 or newer, use the **Get-AzureRmResource** cmdlet instead:
