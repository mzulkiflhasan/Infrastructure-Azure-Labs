...
5. In the hub menu, click **+ Create a resource**, and then click **Management Tools**.
...
7. On the Add Automation Account blade, specify the following and click **Create**:
  ...
  - Resource group: click **Create new**, in the **Name** text box, type **20533E1102-LabRG**, and click **OK**.
