...
6. Review the structure of the JavaScript Object Notation (JSON) file. Examine the placeholders for values that can be edited during the deployment. This template contains the following parameters: ***vnetName***,  ***vnetAddressPrefix***, ***subnet1Prefix***, ***subnet1Name***, ***subnet2Prefix***, ***subnet2Name***, and ***location***.
...
1. On the **Create a Virtual Network with two Subnets** blade, specify the following settings and then click **Purchase**.
  ...
  - Resource group: click **Create new**, type **20533E0203-LabRG** in the **Name** text box, and click **OK**
...
9. Back on the **20533E02-rt1** blade, click **Subnets**.
...
11. On the **Select destination server** page, click **Next**.
