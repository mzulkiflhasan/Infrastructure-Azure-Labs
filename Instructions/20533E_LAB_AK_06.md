...
5. On the Create storage account blade, apply the following settings, and then click **Next : Advanced >**:
  ...
  - Storage Accoutn Name: a valid, unique name consisting of between 3 and 24 lower case characters or digits
...
7. Wait until the storage account is provisioned.
