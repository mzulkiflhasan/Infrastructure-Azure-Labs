...
5. On the Create storage account blade, apply the following settings, and then click **Next : Advanced >**:

  - Subscription: the name of your Azure subscription
  
  - Resource group: click **Create new**, in the **Name** text box type **20533E0602-LabRG**, and click **OK**.

  - Storage account name: a valid, unique name consisting of between 3 and 24 lower case characters or digits
...
6. On the "Advanced" tab, apply the following settings, and click **Review + create**: 
...
7. Click **Create** and wait until the storage account is provisioned.

8. In the hub menu, click **All services**, and then, in the list of services, click **Storage accounts**.

9. On the **Storage accounts** blade, click the storage account that you just created.

10. On the storage account blade, click the **Blobs** tile.

11. On the **Blob service** blade, click **+ Container** in the toolbar.

12. In the **New container** section, specify the following settings, and then click **OK**:
