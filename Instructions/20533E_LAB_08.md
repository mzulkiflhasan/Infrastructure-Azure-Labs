...
1. Download the **Microsoft Azure Recovery Services Agent** from the Azure portal and install it on MIA-CL1 with the default settings. On the **Microsoft Update Opt-In** page of the installation wizard, select the **I do not want to use Microsoft Update** option.
