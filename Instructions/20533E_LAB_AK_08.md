...
6. On the **Microsoft Update Opt-In** page of the **Microsoft Azure Recovery Services Agent Setup Wizard**, select the option **I do not want to use Microsoft Update** and click **Next**.
